...
export const Route = createFileRoute("/signin")({
  ...
  head: () => ({
    meta: [
      { title: "Sign In — Happenin" },
      { name: "description", content: "Sign in to your Happenin account" },
    ],
  }),
});
        ...
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {mode === "forgot"
                ...
                : mode === "signup"
                  ? "Sign up to RSVP, host events, and more"
                  : "Sign in to your Happenin account"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" variant="hero" className="w-full" disabled={loading}>
              {loading ? "Loading..." : mode === "forgot" ? "Send Reset Link" : mode === "signup" ? "Sign Up" : "Sign In"}
            </Button>
          </form>
          ...
          <div className="mt-4 text-center text-sm text-muted-foreground space-y-1">
            ...
            {mode === "signup" && (
              <p>Already have an account? <button onClick={() => setMode("signin")} className="text-primary hover:underline">Sign in</button></p>
            )}
            {mode === "forgot" && (
